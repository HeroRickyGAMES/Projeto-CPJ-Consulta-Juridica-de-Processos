...
class Roraima extends StatelessWidget {
  const Roraima({Key? key}) : super(key: key);
      ...
      body: Column(
          children: [
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  ...
                  String URL = "https://www.tjrr.jus.br/tjrr-siscom-webapp/pages/index.jsp";
            ...
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  String URL = "https://pje.trt11.jus.br/consultaprocessual/pages/consultas/ConsultaProcessual.seam";
