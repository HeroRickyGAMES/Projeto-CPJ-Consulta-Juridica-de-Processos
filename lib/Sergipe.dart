...
class Sergipe extends StatelessWidget {
  const Sergipe({Key? key}) : super(key: key);
      ...
      body: Column(
          children: [
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  ...
                  String URL = "https://monitorarprocesso.com.br/tje/se.html";
            ...
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  String URL = "https://pje.trt20.jus.br/consultaprocessual/";
