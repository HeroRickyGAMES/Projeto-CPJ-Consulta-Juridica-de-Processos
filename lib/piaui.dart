...
class Piaui extends StatelessWidget {
  const Piaui({Key? key}) : super(key: key);
      ...
      body: Column(
          children: [
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  ...
                  String URL = "https://monitorarprocesso.com.br/tje/pi.html";
            ...
            Container(
              ...
              ElevatedButton(
                onPressed: (){
                  String URL = "https://pje.trt22.jus.br/consultaprocessual/";
